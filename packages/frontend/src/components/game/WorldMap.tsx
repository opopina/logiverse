...
export const WorldMap: React.FC<WorldMapProps> = ({
  ...
  const getLevelScore = (level: GameLevel): number | null => {
    return (
      userProgress.scores[level.id as keyof typeof userProgress.scores] || null
    );
  };
  ...
  const getDifficultyColor = (difficulty: number): string => {
    switch (difficulty) {
      ...
      case 3:
        return 'text-loggie-orange';
      case 4:
        return 'text-challenge-red';
      case 5:
        ...
        >
          ...
          <div className="mb-6 p-4 bg-white/10 rounded-lg">
            ...
            <p className="text-white/80 font-source text-sm mb-3">
              ¡Bienvenido a Villa Verdad! Aquí aprenderás los fundamentos de la
              lógica matemática.
            </p>
          ...
          {selectedLevel && (
            ...
            >
              ...
              <div className="space-y-2 text-xs text-white/70">
                <p>
                  ⭐ Dificultad: {getDifficultyStars(selectedLevel.difficulty)}
                </p>
          ...
          <div className="magic-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {world.levels.map((level, index) => {
                ...
                const isCurrent =
                  userProgress.currentLevel === level.levelNumber;
